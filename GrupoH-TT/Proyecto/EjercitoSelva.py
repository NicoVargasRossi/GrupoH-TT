...
imgLeon = pygame.transform.scale(imgLeon, (40, 80))
...
imgCebra = pygame.transform.scale(imgCebra, (40, 80))
...
imgMono = pygame.transform.scale(imgMono, (40, 80))
...
imgTucan = pygame.transform.scale(imgTucan, (40, 80))
...
imgElefante = pygame.transform.scale(imgElefante, (40, 80))
