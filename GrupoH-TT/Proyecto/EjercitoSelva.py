...
mono1 = Token.Token("mono", Icono_Mono_Escalado,3,"Escabullirse",15,"Árboles",None)
mono2 = Token.Token("mono", Icono_Mono_Escalado,3,"Escabullirse",15,"Árboles",None)
mono3 = Token.Token("mono", Icono_Mono_Escalado,3,"Escabullirse",15,"Árboles",None)
mono4 = Token.Token("mono", Icono_Mono_Escalado,3,"Escabullirse",15,"Árboles",None)
...
tucan1 = Token.Token("tucan", Icono_Tucan_Escalado,4,"Vuelo rápido",10,"Todo",None)
tucan2 = Token.Token("tucan", Icono_Tucan_Escalado,4,"Vuelo rápido",10,"Todo",None)
tucan3 = Token.Token("tucan", Icono_Tucan_Escalado,4,"Vuelo rápido",10,"Todo",None)
tucan4 = Token.Token("tucan", Icono_Tucan_Escalado,4,"Vuelo rápido",10,"Todo",None)
...
elefante1 = Token.Token("elefante", Icono_Elefante_Escalado,2,"Inamovible",15,"Agua",None)
elefante2 = Token.Token("elefante", Icono_Elefante_Escalado,2,"Inamovible",15,"Agua",None)
elefante3 = Token.Token("elefante", Icono_Elefante_Escalado,2,"Inamovible",15,"Agua",None)
elefante4 = Token.Token("elefante", Icono_Elefante_Escalado,2,"Inamovible",15,"Agua",None)
#Cartas
