...
Icono_Leon_Escalado = pygame.transform.scale(IconoLeon,(Tablero.tokenW,Tablero.tokenH))
leon1 = Token.Token("leon", Icono_Leon_Escalado, 3 , "Rugido", 10, ["Normal"], None)
leon2 = Token.Token("leon", Icono_Leon_Escalado, 3 , "Rugido", 10, ["Normal"], None)
leon3 = Token.Token("leon", Icono_Leon_Escalado, 3 , "Rugido", 10, ["Normal"], None)
leon4 = Token.Token("leon", Icono_Leon_Escalado, 3 , "Rugido", 10, ["Normal"], None)
IconoCebra = pygame.image.load("Imagenes/LogosAnimales/zebra.png")
Icono_Cebra_Escalado = pygame.transform.scale(IconoCebra,(Tablero.tokenW,Tablero.tokenH))
cebra1 = Token.Token("cebra", Icono_Cebra_Escalado,4,"Correr",15,["Normal"],None)
cebra2 = Token.Token("cebra", Icono_Cebra_Escalado,4,"Correr",15,["Normal"],None)
cebra3 = Token.Token("cebra", Icono_Cebra_Escalado,4,"Correr",15,["Normal"],None)
cebra4 = Token.Token("cebra", Icono_Cebra_Escalado,4,"Correr",15,["Normal"],None)
IconoMono = pygame.image.load("Imagenes/LogosAnimales/mono.png")
Icono_Mono_Escalado = pygame.transform.scale(IconoMono,(Tablero.tokenW,Tablero.tokenH))
mono1 = Token.Token("mono", Icono_Mono_Escalado,3,"Escabullirse",15,["Normal", "Bosque"],None)
mono2 = Token.Token("mono", Icono_Mono_Escalado,3,"Escabullirse",15,["Normal", "Bosque"],None)
mono3 = Token.Token("mono", Icono_Mono_Escalado,3,"Escabullirse",15,["Normal", "Bosque"],None)
mono4 = Token.Token("mono", Icono_Mono_Escalado,3,"Escabullirse",15,["Normal", "Bosque"],None)
IconoTucan = pygame.image.load("Imagenes/LogosAnimales/tucan.png")
Icono_Tucan_Escalado = pygame.transform.scale(IconoTucan,(Tablero.tokenW,Tablero.tokenH))
tucan1 = Token.Token("tucan", Icono_Tucan_Escalado,4,"Vuelo rápido",10,["Normal", "Bosque", "Agua"],None)
tucan2 = Token.Token("tucan", Icono_Tucan_Escalado,4,"Vuelo rápido",10,["Normal", "Bosque", "Agua"],None)
tucan3 = Token.Token("tucan", Icono_Tucan_Escalado,4,"Vuelo rápido",10,["Normal", "Bosque", "Agua"],None)
tucan4 = Token.Token("tucan", Icono_Tucan_Escalado,4,"Vuelo rápido",10,["Normal", "Bosque", "Agua"],None)
IconoElefante = pygame.image.load("Imagenes/LogosAnimales/elephant.png")
Icono_Elefante_Escalado = pygame.transform.scale(IconoElefante,(Tablero.tokenW,Tablero.tokenH))
elefante1 = Token.Token("elefante", Icono_Elefante_Escalado,2,"Inamovible",15,["Normal", "Agua"], None)
elefante2 = Token.Token("elefante", Icono_Elefante_Escalado,2,"Inamovible",15,["Normal", "Agua"],None)
elefante3 = Token.Token("elefante", Icono_Elefante_Escalado,2,"Inamovible",15,["Normal", "Agua"],None)
elefante4 = Token.Token("elefante", Icono_Elefante_Escalado,2,"Inamovible",15,["Normal", "Agua"],None)
#Cartas
imgLeon = pygame.image.load("Imagenes/ImgCartas/Carta_Leon.png")
imgLeon = pygame.transform.rotate(pygame.transform.scale(imgLeon, (Tablero.carta_ManoH, Tablero.carta_ManoW)), 90)
...
imgCebra = pygame.transform.rotate(pygame.transform.scale(imgCebra, (Tablero.carta_ManoH, Tablero.carta_ManoW)), 90)
...
imgMono = pygame.transform.rotate(pygame.transform.scale(imgMono, (Tablero.carta_ManoH, Tablero.carta_ManoW)), 90)
...
imgTucan = pygame.transform.rotate(pygame.transform.scale(imgTucan, (Tablero.carta_ManoH, Tablero.carta_ManoW)), 90)
...
imgElefante = pygame.transform.rotate(pygame.transform.scale(imgElefante, (Tablero.carta_ManoH, Tablero.carta_ManoW)), 90)
